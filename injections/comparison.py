...
#     # load sub results
#     results10 = np.genfromtxt("%s/results/%s_%s_10_results.txt" %
#                                (DIR, n, fname)).T
...
#              yerr=(m[1, :], m[2, :]), **reb)
plt.plot(true_p, true_m, '.', color=ocols.pink, markersize=10)
plt.plot(success_p, success_m, '.', color=ocols.blue, markersize=10)
